...
1. They lurk in the shadows.
                         choice: """)) -1
file_list = ["f1.txt", 0, 0, 0] #add your own file here to use.
...
while True:
    ...
    while True:
        ...
        try:
            ...
            input ("Do you understand. once you give an input here the error chain may or may not continue. if it doesn't keep playing, if it does restart and insert the context you copied: ")
            break
print (promptnum)
